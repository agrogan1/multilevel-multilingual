...
In the examples below, I create a group level variable for `warmth`, representing the average level of warmth in each country. If warmth is denoted by $\text{warmth}_{ij}$ then the country level variable is denoted by $\overline{warmth}_{.j}$.
