...
Remember, following Section 6.4, that in longitudinal multilevel models, the variable for *time* assumes a special role as we are often thinking of a *growth trajectory* over time.
