...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, frame hidden, interior hidden, sharp corners, breakable]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, opacityback=0, coltitle=black, toprule=.15mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, arc=.35mm, left=2mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip For Running Stata From Quarto}, colframe=quarto-callout-tip-color-frame]
