...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Multi-Line Commands}, opacityback=0, titlerule=0mm, toprule=.15mm, breakable, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, coltitle=black, colback=white, toptitle=1mm, arc=.35mm, left=2mm, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Main Effects and Interactions}, opacityback=0, titlerule=0mm, toprule=.15mm, breakable, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, coltitle=black, colback=white, toptitle=1mm, arc=.35mm, left=2mm, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white]
