...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, opacityback=0, bottomtitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip For Running Stata From Quarto}, left=2mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, leftrule=.75mm, titlerule=0mm, breakable, arc=.35mm, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colback=white]
