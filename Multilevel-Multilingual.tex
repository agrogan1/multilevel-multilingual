...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, opacitybacktitle=0.6, breakable, titlerule=0mm, bottomtitle=1mm, opacityback=0, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip For Running Stata From Quarto}, rightrule=.15mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white, leftrule=.75mm, left=2mm]
...
\includegraphics{index_files/figure-pdf/fig-R-1.pdf}
...
\includegraphics{index_files/figure-pdf/fig-Julia-J1.pdf}
...
\begin{equation}\phantomsection\label{eq-crossclassifiedsubstantive}{\text{outcome}_{ijt}= \beta_0 + \beta_1 t_{ijt} + \beta_2 \text{warmth}_{ijt} + \beta_3 \text{physical punishment}_{ijt} + \\ \beta_4 \text{group}_{ijt} + \beta_5 \text{HDI}_{ijt} + \\ u_{0j} + v_{0i} + e_{ijt}}\end{equation}
...
\begin{equation}\phantomsection\label{eq-crossclassfiedsimple}{y = \beta_0 + \beta_1 x_{ijt} + \beta_2 z_{ijt} + u_{0j} + v_{0i} + e_{ijt}}\end{equation}
