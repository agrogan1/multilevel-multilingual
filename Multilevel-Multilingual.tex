...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, leftrule=.75mm, colback=white, left=2mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Results Will Vary Somewhat}, bottomtitle=1mm, toptitle=1mm, opacityback=0, toprule=.15mm, breakable, coltitle=black, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, leftrule=.75mm, colback=white, left=2mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Multi-Line Commands}, bottomtitle=1mm, toptitle=1mm, opacityback=0, toprule=.15mm, breakable, coltitle=black, rightrule=.15mm]
