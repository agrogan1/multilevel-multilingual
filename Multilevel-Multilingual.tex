...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Results Will Vary Somewhat}, colframe=quarto-callout-tip-color-frame, coltitle=black, arc=.35mm, colback=white, breakable, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6]
