...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, toptitle=1mm, toprule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip For Running Stata From Quarto}, opacitybacktitle=0.6, titlerule=0mm, colback=white, breakable, bottomtitle=1mm, arc=.35mm, leftrule=.75mm, rightrule=.15mm, left=2mm, coltitle=black]
