...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, breakable, opacityback=0, left=2mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, toprule=.15mm, toptitle=1mm, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip For Running Stata From Quarto}, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
