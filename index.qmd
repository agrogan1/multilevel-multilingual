...
Below, I describe the use of [Stata](https://www.stata.com/) [@StataCorp2023], [R](https://www.r-project.org/) [@RProgram; @JSSv067i01], and [Julia](https://www.julialang.org/) [@JuliaArticle; @MixedModels] to estimate multilevel models and to visualize data. 
