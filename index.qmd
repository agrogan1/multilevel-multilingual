...
Many statistical workflows follow the same conceptual pattern.
...
It is usually best to store quantitative data in a statistical format such as R (`.Rdata`), or Stata (`.dta`). Spreadsheets are likely to be a bad tool for storing quantitative data.
:::

::: {.callout-tip}
## It Is Possible To Use Multiple Statistical Packages
