...
Below, I describe the use of Stata, R, and Julia to estimate multilevel models. Because this document is built by [`quarto`](https://quarto.org/), I describe calling these programs from within a `quarto` environment. However, each piece of software could be used individually and separately.

## The Data

The examples below use the `simulated_multilevel_data.dta` file from [*Multilevel Thinking*](https://agrogan1.github.io/multilevel-thinking/).
